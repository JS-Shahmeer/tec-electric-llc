  ...
  if (status === "done") {
    return (
      <div className="border border-amber/40 bg-amber/5 p-10 text-center">
        ...
        <p className="text-white mt-3">Thank you, {form.name.split(" ")[0]}. A project manager will reach out within one business day.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="space-y-2">
          <Label className="text-white font-mono text-xs tracking-wider">INDUSTRY</Label>
        ...
        <div className="space-y-2">
          <Label className="text-white font-mono text-xs tracking-wider">PROJECT LOCATION</Label>
        ...
        <div className="space-y-2">
          <Label className="text-white font-mono text-xs tracking-wider">ESTIMATED BUDGET</Label>
      ...
      <div className="space-y-2">
        <Label className="text-white font-mono text-xs tracking-wider">PROJECT DETAILS</Label>
        <Textarea className="block w-full bg-white/5 border-white/15 text-white placeholder:text-white focus-visible:ring-amber min-h-32" value={form.message} onChange={(e) => set("message", e.target.value)} placeholder="Tell us about scope, timeline, and objectives…" />
      </div>
